...
func TestAlterRoleSet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ars, ok := stmt.(*AlterRoleSetStmt)
			if !ok {
				t.Fatalf("expected *AlterRoleSetStmt, got %T", stmt)
			}
...
func TestAlterDomainStmt(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ad, ok := stmt.(*AlterDomainStmt)
			if !ok {
				t.Fatalf("expected *AlterDomainStmt, got %T", stmt)
			}
...
func TestAlterEnumType(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ae, ok := stmt.(*AlterEnumStmt)
			if !ok {
				t.Fatalf("expected *AlterEnumStmt, got %T", stmt)
			}
			if ae.NewVal == "" {
...
func TestAlterFunction(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			af, ok := stmt.(*AlterFunctionStmt)
			if !ok {
				t.Fatalf("expected *AlterFunctionStmt, got %T", stmt)
			}
			if af.Func == nil {
...
func TestAlterPublication(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ap, ok := stmt.(*AlterPublicationStmt)
			if !ok {
				t.Fatalf("expected *AlterPublicationStmt, got %T", stmt)
			}
			if ap.Pubname != "mypub" {
...
func TestAlterSubscription(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			as, ok := stmt.(*AlterSubscriptionStmt)
			if !ok {
				t.Fatalf("expected *AlterSubscriptionStmt, got %T", stmt)
			}
			if as.Subname != "mysub" {
...
func TestAlterEventTrigger(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ae, ok := stmt.(*AlterEventTrigStmt)
			if !ok {
				t.Fatalf("expected *AlterEventTrigStmt, got %T", stmt)
			}
...
func TestAlterSystem(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			as, ok := stmt.(*AlterSystemStmt)
			if !ok {
				t.Fatalf("expected *AlterSystemStmt, got %T", stmt)
			}
			if as.SetStmt == nil {
				t.Fatal("expected non-nil SetStmt")
			}
