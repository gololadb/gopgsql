...
func TestCreateDatabase(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			...
			cd, ok := stmt.(*parser.CreatedbStmt)
			if !ok {
				t.Fatalf("expected *parser.CreatedbStmt, got %T", stmt)
			}
			if cd.Dbname != "mydb" {
...
func TestDropDatabase(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			dd, ok := stmt.(*parser.DropdbStmt)
			if !ok {
				t.Fatalf("expected *parser.DropdbStmt, got %T", stmt)
			}
			if dd.Dbname != "mydb" {
...
func TestAlterDatabase(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ad, ok := stmt.(*parser.AlterDatabaseStmt)
			if !ok {
				t.Fatalf("expected *parser.AlterDatabaseStmt, got %T", stmt)
			}
			if ad.Dbname != "mydb" {
...
func TestAlterDatabaseSet(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ads, ok := stmt.(*parser.AlterDatabaseSetStmt)
			if !ok {
				t.Fatalf("expected *parser.AlterDatabaseSetStmt, got %T", stmt)
			}
			if ads.Dbname != "mydb" {
...
func TestCreateTablespace(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ct, ok := stmt.(*parser.CreateTableSpaceStmt)
			if !ok {
				t.Fatalf("expected *parser.CreateTableSpaceStmt, got %T", stmt)
			}
