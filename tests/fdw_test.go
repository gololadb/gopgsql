...
func TestCreateFdw(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			...
			cf, ok := stmt.(*parser.CreateFdwStmt)
			if !ok {
				t.Fatalf("expected *parser.CreateFdwStmt, got %T", stmt)
			}
			if cf.Fdwname != "myfdw" {
...
func TestCreateServer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			cs, ok := stmt.(*parser.CreateForeignServerStmt)
			if !ok {
				t.Fatalf("expected *parser.CreateForeignServerStmt, got %T", stmt)
			}
...
func TestCreateForeignTable(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			cft, ok := stmt.(*parser.CreateForeignTableStmt)
			if !ok {
				t.Fatalf("expected *parser.CreateForeignTableStmt, got %T", stmt)
			}
...
func TestCreateUserMapping(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			cum, ok := stmt.(*parser.CreateUserMappingStmt)
			if !ok {
				t.Fatalf("expected *parser.CreateUserMappingStmt, got %T", stmt)
			}
...
func TestImportForeignSchema(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.desc, func(t *testing.T) {
			stmt := parseOne(t, tt.sql)
			ifs, ok := stmt.(*parser.ImportForeignSchemaStmt)
			if !ok {
				t.Fatalf("expected *parser.ImportForeignSchemaStmt, got %T", stmt)
			}
...
func TestCreateUserStillWorks(t *testing.T) {
	...
	cr, ok := stmt.(*parser.CreateRoleStmt)
	if !ok {
